...
const int max_valueX = 1280;
const int max_valueY = 720;
...
{
	low_H = min(high_H - 1, low_H);//диапозон значений
...
int main(int argc, char* argv[]) 
{
	...
	frameCropped_vertices[1] = Point(1280, 0);
	frameCropped_vertices[2] = Point(1280, 720);// 640x480
	frameCropped_vertices[3] = Point(0, 720);

	Mat M = getPerspectiveTransform(frame_vertices, frameCropped_vertices);
	Mat frameCropped(720, 1280, CV_8UC3);
	warpPerspective(frame, frameCropped, M, frameCropped.size(), INTER_LINEAR, BORDER_CONSTANT);

	Mat frame2Cropped(720, 1280, CV_8UC3);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	line(frame, Point(high_X1, high_Y1), Point(high_X1, high_Y1), Scalar(0, 255, 0), 6, LINE_AA);
	line(frame, Point(high_X2, high_Y2), Point(high_X2, high_Y2), Scalar(0, 255, 0), 6, LINE_AA);
	line(frame, Point(high_X3, high_Y3), Point(high_X3, high_Y3), Scalar(0, 255, 0), 6, LINE_AA);
	line(frame, Point(high_X4, high_Y4), Point(high_X4, high_Y4), Scalar(0, 255, 0), 6, LINE_AA);
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	namedWindow("frame_threshold", CV_WINDOW_NORMAL);
	resizeWindow("frame_threshold", 300, 300);
	imshow("frame_threshold", frame_threshold);
	namedWindow(video_dorogi, CV_WINDOW_NORMAL);
